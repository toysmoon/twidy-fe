...
const FolderItem: FC<IFolderProps> = ({ folder, onClick }) => {
  ...
  return (
    <div onClick={onClick} className="flex py-5 mx-5 items-center justify-between border-b border-gray6">
      <div className="flex items-center overflow-hidden">
        ...
        <p className="text-base leading-5 text-black ml-2 mr-1 overflow-hidden whitespace-nowrap text-ellipsis">
          {name}
        </p>
